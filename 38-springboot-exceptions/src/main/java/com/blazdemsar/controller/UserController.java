...
import com.blazdemsar.utilities.UserNotFoundException;
...
public class UserController {
   ...
   // The method that show how @Controller advice can play a central role to handle the Exceptions
   @RequestMapping(value="findUserByName")
   public ResponseEntity<User> findByName(@RequestParam String name){
	   
	   User user = userService.findByName(name);
	   if(user==null) throw new UserNotFoundException( "There is no user whose name is <strong>"+ name + "</strong>.");

...
<body>
	...
	<div class="container">
		...
		<br />
		<p>
			Making a new account means you can navigate our site with ease.<br />Just
			fill out our registration form and you're ready to enjoy our<br />
			endless services and benefits!
		</p>
		<br/>
		<frm:form action="saveUser" method="POST" modelAttribute="user"
			...
			<div class="form-group">
				...
				<frm:input path="username" class="form-control" placeholder="Username" id="username" />
			</div>
			<div class="form-group">
				<label>Password:</label>
				<frm:input type="password" path="password" class="form-control" placeholder="Password" id="password" />
			</div>
			<div class="form-group">
				<label>Email:</label>
				<frm:input path="email" class="form-control" placeholder="E-mail" id="email" />
			</div>
			<div class="form-group">
				<label>Phone Number:</label>
				<frm:input path="phoneNumber" class="form-control" placeholder="Phone Number" id="phoneNumber" />
			</div>
			<sec:authorize access="hasAuthority('Administrator') || hasAuthority('Manager')">
				<div class="form-group">
					<label>Roles:</label>
					<frm:select class="form-control" path="roles">
						<frm:option selected="selected" value="">Select A Role</frm:option>
						<c:forEach items="${roleSet}" var="role">
							<frm:option value="${role.roleId}">${role.roleName}</frm:option>
						</c:forEach>
					</frm:select>
				</div>
			</sec:authorize>

...
public class EmployeeRestController {
	...
	/*
	 * Assignment: Copy the existing restful webservice project to create a new
	 * project by changing the name of the project. The project name should reflect
	 * today's date and assignment. You should delete existing Controllers and
	 * create a new RestController and implement the CRUD methods for Employee
	 * entity in this controller. You should test your methods using restful client
	 * PostMan. Ignore typo if any and feel free to ask in case of any ambiguity.
	 */
			...
			if (br.hasFieldErrors()) {
				...
				for (FieldError fieldError : errors) {
					errorMessage = errorMessage
							.append("\"" + fieldError.getField() + "\" " + fieldError.getDefaultMessage() + "\n");
...
/*
 * <Employee> <empId>9</empId> <name>Rocky</name> <job>DBA MSQL</job>
 * <salary>3500</salary> <dob>807001200000</dob> <gender>male</gender>
 * <spokenLanguages> <spokenLanguages>Spanish</spokenLanguages>
 * <spokenLanguages>English</spokenLanguages>
 * <spokenLanguages>Spanish</spokenLanguages>
 * <spokenLanguages>English</spokenLanguages> </spokenLanguages> <skills>
 * <skills>Java</skills> <skills>MySQL</skills> </skills> <hobbies>
 * <hobbies>Cycling</hobbies> </hobbies> <employeeType>FULL_TIME</employeeType>
 * <insured>true</insured> <email>ramesh@gmail.com</email>
 * <mobile>999976654343</mobile> <nationality>India</nationality> <address>
 * <addressLine1>al1</addressLine1> <addressLine2>al2</addressLine2>
 * <city>city1</city> <state>city2</state> </address> </Employee>
 */

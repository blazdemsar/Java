...
public class RoleRestClientImpl implements RoleRestClient {
	...
	public JSONObject getAllRoles() throws JSONException, JsonProcessingException {
		...
		System.out.println("Request for getting all roles received .............");
		...
		ResponseEntity<Object[]> responseEntity = restTemplate.postForEntity(uri +"/getAllRoles", request, Object[].class);
		Object[] listOfRoles = responseEntity.getBody();

		JSONArray jsonArray = new JSONArray();

		for(Object obj : listOfRoles){
		...
		jsonResponseObject.put("listOfRoles", jsonArray);

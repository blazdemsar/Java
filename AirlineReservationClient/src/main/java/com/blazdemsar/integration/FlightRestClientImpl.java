...
public class FlightRestClientImpl implements FlightRestClient {
	...
	public JSONObject getAllFlights() throws JSONException, JsonProcessingException {
		...
		System.out.println("Request for getting all flights received .............");
		...
		ResponseEntity<Object[]> responseEntity = restTemplate.postForEntity(uri +"/getAllFlights", request, Object[].class);
		Object[] listOfFlights = responseEntity.getBody();
		...
		jsonResponseObject.put("listOfFlights", jsonArray);

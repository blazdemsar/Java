...
public class UserRestClientImpl implements UserRestClient {
	...
	public JSONObject getAllUsers() throws JSONException, JsonProcessingException {
		...
		System.out.println("Request for getting all users received .............");
		...
		ResponseEntity<Object[]> responseEntity = restTemplate.postForEntity(uri +"/getAllUsers", request, Object[].class);
		Object[] listOfUsers = responseEntity.getBody();
		...
		jsonResponseObject.put("listOfUsers", jsonArray);
